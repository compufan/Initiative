...
/*
 * Flutung, Ausweitung und Weichzeichner stehen jetzt in
 * `engines/flutung.ts` – sie haben seit dem Fotoeditor zwei Aufrufer, und
 * keiner der beiden braucht die Zeichenkette der Sticker.
 *
 * Hier weitergegeben, damit sich fuer die bisherigen Aufrufer und fuer
 * `render.test.ts` nichts aendert.
 */
export { dilateAlpha, flutmaske } from './engines/flutung.js';
import { blurAlpha, colourDistance, dilateAlpha, flutmaske } from './engines/flutung.js';
